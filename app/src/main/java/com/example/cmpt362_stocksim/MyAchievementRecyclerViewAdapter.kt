...
class MyAchievementRecyclerViewAdapter() : RecyclerView.Adapter<MyAchievementRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(binding: FragmentAchievementBinding) :
